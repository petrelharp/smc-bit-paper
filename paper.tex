...
by randomly choosing an ordering, and uncertainty communicated by the order
...
the likelihood of an ARG given a complete description of 

, such complete detail is not present 
