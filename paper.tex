...
These are inferred by \tsinfer, \kwarg, \argweaver. %add citation

% what happens in the partial or complete absence of unary nodes
% even in the absence of unary nodes we can compute a likelihood, however, this has an impact.

% The SMC and unary nodes
% ADD: figure here that tries to deal with all possible causes of confusion
% unary nodes mainly

% highlight the amount of information that needs to be tracked to compute a likelihood
% for the exact Hudson CwR
