...
backwards-time formulation of the SMC based on a total ordering of 
lineages, and show how this leads to straightforward description 
of the likelihood of a general class of ARG under the SMC. We show that this 
formulation does not require precise details of recombination events
to be estimated, and is robust to other topological issues such as 
...
% TODO need to rewrite this as its too tskit-centric. We don't need to 
% emphasise tskit/msprime so much here, it's not necessary and will 
% annoy people. 
