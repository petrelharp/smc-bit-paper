...
\section{Likelihood surface for larger class of ARGs}


% flexibility
% presence of polytomies
% lack of unary nodes

\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{figures/likelihood_surface.png}
    \caption{Simulated ARG under SMC ($L=1$Mb, $100$ diploid samples,
    $r=2.5e-8$, $N_e=1e4$). Likelihood-ratio contour plot. Currently two contours,
    with and without locally unary nodes.}
