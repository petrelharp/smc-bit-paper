...
simplifies bookkeeping somewhat, 
...
which contain no information about recombination events (other than their
breakpoints) and where internal nodes marking coalesces are unlabelled.
The \texttt{msprime}
...
contain the level of detail required to compute a likelihood under
the KYF approach.
