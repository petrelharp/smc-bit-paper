...
Thanks -- we're glad you appreciated the paper.
...
\reply{
We have added pseudocode descriptions of the two main algorithms in the
appendix.
}
...
\reply{
    Done -- hopefully this helps. \revref
}
...
We're glad the paper found a warm welcome.
And, thanks very much for your attention to detail in the comments.
...
\reply{
    Nice idea -- we've done this, and hope it doesn't add too much to the complexity of the figures.
}
...
\reply{
We feel that ``tree-valued process'' is a fairly well established term in
more mathematical literature and would prefer to keep it as-is.
}
...
\reply{
    Good point, we shouldn't let a nice acronym like this go unexplained.
    We think the algorithm is at least relatively unaware of the times,
    and so we're okay with the current acronym.
}
